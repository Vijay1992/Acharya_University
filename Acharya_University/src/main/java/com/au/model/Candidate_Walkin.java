...
public class Candidate_Walkin {
	...
	public Candidate_Walkin(Integer candidate_id, Date date_of_visit, Integer visitor_id, String candidate_name,
			String candidate_sex, Date date_of_birth, String mobile_number, Integer purpose_of_visit_id,
			Integer visitor_type_id, Integer ac_year_id, String father_name, Integer city_id, Integer state_id,
			Integer country_id, Integer school_id, Integer program_id, Integer program_specilaization_id,
			String remarks, String rep_name, Integer created_by, Date created_date, Integer modified_by,
			Date modified_date, Boolean active, Date date_of_admission, String candidate_email, String nationality,
			String category, String caste, String religion, String place_of_birth, String blood_group,
			String present_address, Integer present_pincode, String present_country, String present_state,
			String permanent_address, Integer permanent_pincode, String permanent_country, String permanent_state,
			String permanent_city, Integer alternate_contact_number_permanent, String father_occupation,
			String father_email, String father_qualification, float father_annual_income, String father_mobile,
			String mother_name, String mother_occupation, String mother_email, String mother_qualification,
			String mother_mobile, String guardian_name, String guardian_city, String guardian_relation_to_student,
			String guardian_email, String guardian_address, String guardian_pincode, Integer guardian_mobile,
			String sslc_school_name, Integer sslc_year_of_passing, String sslc_board, Integer sslc_registration_number,
			float sslc_percentage_grade, String puc_school_name, String puc_board, String is_puc_result,
			String puc_mode_of_study, Integer puc_registration_number, Integer puc_year_of_passing,
			float puc_percentage_grade, String evaluation_type, String puc_subjects, float puc_subject_max_marks,
			float puc_subject_marks_obtain, float puc_percentage_obtain, String entrance_exam_name,
			float marks_rank_obtain, String degree_diploma, String pg_diploma, String photo, Integer other_candidate_id,
			Integer alternate_contact_number_present, String school_npf, String program_npf,
			String program_specilization_npf, String application_no_npf, String visitor_type_npf,
			String course_branch_subtype_npf, String counselor_remarks, Integer counselor_status, Integer paid_status,
			String voucher_code, Integer form_id, Integer npf_status) {
		super();
	...
	public String toString() {
		return "Candidate_Walkin [candidate_id=" + candidate_id + ", date_of_visit=" + date_of_visit + ", visitor_id="
				+ visitor_id + ", candidate_name=" + candidate_name + ", candidate_sex=" + candidate_sex
				+ ", date_of_birth=" + date_of_birth + ", mobile_number=" + mobile_number + ", purpose_of_visit_id="
				+ purpose_of_visit_id + ", visitor_type_id=" + visitor_type_id + ", ac_year_id=" + ac_year_id
				+ ", father_name=" + father_name + ", city_id=" + city_id + ", state_id=" + state_id + ", country_id="
				+ country_id + ", school_id=" + school_id + ", program_id=" + program_id
				+ ", program_specilaization_id=" + program_specilaization_id + ", remarks=" + remarks + ", rep_name="
				+ rep_name + ", created_by=" + created_by + ", created_date=" + created_date + ", modified_by="
				+ modified_by + ", modified_date=" + modified_date + ", active=" + active + ", date_of_admission="
				+ date_of_admission + ", candidate_email=" + candidate_email + ", nationality=" + nationality
				+ ", category=" + category + ", Caste=" + Caste + ", Religion=" + Religion + ", Place_of_birth="
				+ Place_of_birth + ", Blood_group=" + Blood_group + ", Present_address=" + Present_address
				+ ", present_pincode=" + present_pincode + ", present_country=" + present_country + ", present_state="
				+ present_state + ", permanent_address=" + permanent_address + ", permanent_pincode="
				+ permanent_pincode + ", permanent_country=" + permanent_country + ", permanent_state="
				+ permanent_state + ", permanent_city=" + permanent_city + ", alternate_contact_number_permanent="
				+ alternate_contact_number_permanent + ", father_occupation=" + father_occupation + ", father_email="
				+ father_email + ", father_qualification=" + father_qualification + ", father_annual_income="
				+ father_annual_income + ", father_mobile=" + father_mobile + ", mother_name=" + mother_name
				+ ", mother_occupation=" + mother_occupation + ", mother_email=" + mother_email
				+ ", mother_qualification=" + mother_qualification + ", mother_mobile=" + mother_mobile
				+ ", guardian_name=" + guardian_name + ", guardian_city=" + guardian_city
				+ ", guardian_relation_to_student=" + guardian_relation_to_student + ", guardian_email="
				+ guardian_email + ", guardian_address=" + guardian_address + ", guardian_pincode=" + guardian_pincode
				+ ", guardian_mobile=" + guardian_mobile + ", sslc_school_name=" + sslc_school_name
				+ ", sslc_year_of_passing=" + sslc_year_of_passing + ", sslc_board=" + sslc_board
				+ ", sslc_registration_number=" + sslc_registration_number + ", sslc_percentage_grade="
				+ sslc_percentage_grade + ", puc_school_name=" + puc_school_name + ", puc_board=" + puc_board
				+ ", is_puc_result=" + is_puc_result + ", puc_mode_of_study=" + puc_mode_of_study
				+ ", puc_registration_number=" + puc_registration_number + ", puc_year_of_passing="
				+ puc_year_of_passing + ", puc_percentage_grade=" + puc_percentage_grade + ", evaluation_type="
				+ evaluation_type + ", puc_subjects=" + puc_subjects + ", puc_subject_max_marks="
				+ puc_subject_max_marks + ", puc_subject_marks_obtain=" + puc_subject_marks_obtain
				+ ", puc_percentage_obtain=" + puc_percentage_obtain + ", entrance_exam_name=" + entrance_exam_name
				+ ", marks_rank_obtain=" + marks_rank_obtain + ", degree_diploma=" + degree_diploma + ", pg_diploma="
				+ pg_diploma + ", photo=" + photo + ", other_candidate_id=" + other_candidate_id
				+ ", alternate_contact_number_present=" + alternate_contact_number_present + ", school_npf="
				+ school_npf + ", program_npf=" + program_npf + ", program_specilization_npf="
				+ program_specilization_npf + ", application_no_npf=" + application_no_npf + ", visitor_type_npf="
				+ visitor_type_npf + ", course_branch_subtype_npf=" + course_branch_subtype_npf + ", counselor_remarks="
				+ counselor_remarks + ", counselor_status=" + counselor_status + ", paid_status=" + paid_status
				+ ", voucher_code=" + voucher_code + ", form_id=" + form_id + ", npf_status=" + npf_status + "]";
	}
