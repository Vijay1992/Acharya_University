...
//	private String program_specialization;
	...
	public FeeTemplate(Integer fee_template_id, String fee_template_name, Integer ac_year_id, Integer school_id,
			Integer program_id, String program_specialization_id, Integer currency_id,
			Integer fee_admission_category_id, Integer fee_admission_sub_category_id, Boolean is_paid_at_board,
			String nationality, Boolean is_nri, Integer program_type_id, Integer approved_by, Boolean approved_status,
