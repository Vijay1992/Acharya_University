...
public class BoardSchoolAssignment {
	...
	public BoardSchoolAssignment() {
		super();
	}

	public BoardSchoolAssignment(Integer board_school_assignment_id, Integer board_unique_id, Integer school_id,
