...
public class Course {
	...
	public Course(int course_id, String course_name, String course_code, Integer course_type_id, Date created_Date,
			Date modified_Date, String course_short_name, Integer course_category_id, Integer total_credit,
			Integer lecture, Integer tutorial, Integer practical, Integer duration, Integer dept_id, Integer cie_marks,
			Integer see_marks, Integer number_of_years, Integer number_of_semester, Integer created_by,
			Integer modified_by, boolean active, String ref_details, String hod_email, Integer school_id) {
		super();
